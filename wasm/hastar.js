...
var ASM_CONSTS = {
  92380: () => { if (document.fullscreenElement) return 1; },  
 92426: () => { return document.getElementById('canvas').width; },  
 92478: () => { return parseInt(document.getElementById('canvas').style.width); },  
 92546: () => { document.exitFullscreen(); },  
 92573: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 92646: () => { if (document.fullscreenElement) return 1; },  
 92692: () => { return document.getElementById('canvas').width; },  
 92744: () => { return screen.width; },  
 92769: () => { document.exitFullscreen(); },  
 92796: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 92929: () => { if (document.fullscreenElement) return 1; },  
 92975: () => { return document.getElementById('canvas').width; },  
 93027: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93095: () => { if (document.fullscreenElement) return 1; },  
 93141: () => { return document.getElementById('canvas').width; },  
 93193: () => { return screen.width; },  
 93218: () => { if (document.fullscreenElement) return 1; },  
 93264: () => { return document.getElementById('canvas').width; },  
 93316: () => { return screen.width; },  
 93341: () => { document.exitFullscreen(); },  
 93368: () => { if (document.fullscreenElement) return 1; },  
 93414: () => { return document.getElementById('canvas').width; },  
 93466: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93534: () => { document.exitFullscreen(); },  
 93561: () => { return screen.width; },  
 93586: () => { return screen.height; },  
 93612: () => { return window.screenX; },  
 93639: () => { return window.screenY; },  
 93666: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 93719: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 93790: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 93847: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 93918: () => { if (document.fullscreenElement) return 1; },  
 93964: () => { if (document.pointerLockElement) return 1; }
};
...
var ___start_em_js = Module['___start_em_js'] = 94011;
var ___stop_em_js = Module['___stop_em_js'] = 94084;
